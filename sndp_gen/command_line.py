...
def command_line():
    ...
    result = False
    cwd = Path(__file__).cwd() # do I need it?
    ...
    if list_num_locations is None:
        ...
        for num_locations in list_num_locations:
            for num_products in list_num_products:
                for variation in range(num_variations):
                    ...
                    # stochastic_model.set_data(graph.data_as_dict())
                    # stochastic_model.save_data(instance_name)
                    # graph.visualize(to_file=stochastic_model.get_instances_directory() + instance_name)
        ...
        # stochastic_model.set_initial_data()
        result = True
